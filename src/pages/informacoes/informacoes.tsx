        ...
        <Container>
                <CardsSubContainer>
                    <CivelContainer>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/contenciosocivil')}>• Contencioso Civil </ServiceTitle>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/direitodefamilia')}>• Direito de Família</ServiceTitle>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/contratosenegociacoes')}>• Contratos e Negociações</ServiceTitle>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/inventario')}>• Inventário e Partilha de Bens</ServiceTitle>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/danosmorais')}>• Ações de Indenização por Danos Morais:</ServiceTitle>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/adocao')}>• Adoção</ServiceTitle>
                    ...
                    <ConsumidorContainer>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/vendacasada')}>• Venda Casada</ServiceTitle>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/recusaoferta')}>• Recusa em Cumprir Oferta Anunciada</ServiceTitle>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/constrangimento')}>• Constrangimento ao Consumidor na Cobrança de Débitos</ServiceTitle>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/acoesfabricante')}>• Ações de Responsabilidade do Fabricante</ServiceTitle>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/transacaoonline')}>• Direito do Consumidor em Transações Online</ServiceTitle>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/resolucaoconflitos')}>• Resolução de Conflitos e Mediação</ServiceTitle>
                    ...
                    <CriminalContainer>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/inqueritopolicial')}>• Acompanhamento de Inquérito Policial</ServiceTitle>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/revisaocriminal')}>• Revisão Criminal</ServiceTitle>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/violenciadomestica')}>• Violência Doméstica</ServiceTitle>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/crimesfinanceiros')}>• Crimes Financeiros</ServiceTitle>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/traficodrogas')}>• Tráfico de Drogas</ServiceTitle>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/sentencarevisao')}>• Recursos e Revisões de Sentenças</ServiceTitle>
                    ...
                    <PrevidenciarioContainer>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/bpcloas')}>• BPC/LOAS</ServiceTitle>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/pensaopormorte')}>• Pensão por Morte</ServiceTitle>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/auxiliodoenca')}>• Auxílio Doença</ServiceTitle>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/aposentadoriainvalidez')}>• Aposentadoria por Invalidez</ServiceTitle>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/revisaobeneficios')}>• Revisão de Benefícios Previdenciários</ServiceTitle>
                        ...
                        <ServiceTitle onClick={() => navigate('/informacoes/reabilitacaoprofissional')}>• Reabilitação Profissional</ServiceTitle>
